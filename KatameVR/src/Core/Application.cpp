...
///////////////////////////////////////////
	...
	void Application::openxr_make_actions() {
	...
	void Application::openxr_shutdown() {
	...
	void Application::openxr_poll_actions() {
	...
	void Application::openxr_poll_predicted( XrTime predicted_time ) {
		if (xr_session_state != XR_SESSION_STATE_FOCUSED)
			return;
	...
	void Application::openxr_render_frame() {
	...
	bool Application::openxr_render_layer( XrTime predictedTime, std::vector<XrCompositionLayerProjectionView>& views, XrCompositionLayerProjection& layer ) {
