...
namespace Katame
{
    ...
    Cube::Cube( Graphics* gfx, Data data, float size )
        :
        m_Data( data )
    {
        ...
        auto pvs = VertexShader::Resolve( gfx, "./Shaders/Bin/VertexShader.cso" );
        auto pvsbc = pvs->GetBytecode();
        AddBind( std::move( pvs ) );

        AddBind( PixelShader::Resolve( gfx, "./Shaders/Bin/PixelShader.cso" ) );
